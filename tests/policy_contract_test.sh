...
assert_contains 'environment_admin_token' "$ami_workflow"
assert_contains 'GH_TOKEN: ${{ secrets.environment_admin_token }}' "$ami_workflow"
...
assert_contains 'environment_admin_token' "$project_root/.github/workflows/deploy-backend-infra.yml"
